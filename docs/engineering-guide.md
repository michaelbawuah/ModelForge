...
- [Architecture and system invariants](architecture.md)
- [External runtime contract](runtime-protocol.md)
- [Public-cloud deployment contract](cloud-deployment.md)
- [AWS ECS/Fargate reference deployment](../infra/aws/README.md)
- [Deployment validation scenario](demo-proof.md)
